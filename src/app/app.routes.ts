...
import { ProjectDetailComponent } from './proyectos/project-detail/project-detail.component';
...
export const routes: Routes = [
  ...
  { path: 'proyectos/:slug', component: ProjectDetailComponent, data: { animation: 'ProjectDetailPage' } },
